...
class RDFunctionSet(ThingWithCommonRD, Resource):
    ...
    def render_post(self, request):
        ...
        self.common_rd.initialize_endpoint(key, ep=query['ep'], lt=lt, con=query.get('con', request.remote.sockaddr[0]), d=query.get('d', None), et=query.get('et', None))
